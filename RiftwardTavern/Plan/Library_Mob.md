...
(2023-06-01 https://roll20.net/compendium/dnd5e/Noble\#h-Noble)

## Rapier

Melee +3 atk, 1d8+1 piercing

## Parry

React: The noble adds 2 to its AC against one melee attack that would hit it. To do so, the noble must see the attacker and be wielding a melee weapon.
...
Languages: Any (can’t speak)

(2023-06-01 https://roll20.net/compendium/dnd5e/Monsters:Skeleton/\#h-Skeleton)

## Shortsword

Melee +4 atk, 1d6+2 piercing

## Shortbow

Ranged +4 atk (80/320), 1d6+2 piercing

# Vulture

7-10-13-2-12-4

| 10 AC | 5 HP | 10ft, fly 50ft | 13pz |
|-------|------|----------------|------|

Perception +3

Keen Sight, Keen Smell, Pack Tactics

[Vulture 2023-06-01](https://roll20.net/compendium/dnd5e/Monsters:Vulture/#h-Vulture)

## Beak

Melee +2 atk, 1d4 piercing

# Cave Spider

3-13-10-1-7-1

| 12 AC | 22 HP | 20ft, climb 20ft | 8pz |
|-------|-------|------------------|-----|
...
Blindsight 10ft, Spider Climb, Web Sense, Web Walker

[Swarm of Spiders 2023-06-01](https://roll20.net/compendium/dnd5e/Monsters:Swarm%20of%20Spiders/#h-Swarm%20of%20Spiders)

## Bite

Melee +3 atk, 4d4 piercing

## Web

Creates a string of web behind the spider. Web turns squares into difficult terrain. Any creature that ends their turn in the web becomes restrained. A restrained creature can use an action to make a DC10 Strength check to free itself.

# Gargoyle

15-11-16-6-11-7

| 15 AC | 52 HP | 30ft, fly 60ft | 10pz |
|-------|-------|----------------|------|

Weak: Magical, Adamantine
...
[Gargoyle 2023-06-01](https://roll20.net/compendium/dnd5e/Gargoyle#h-Gargoyle)
